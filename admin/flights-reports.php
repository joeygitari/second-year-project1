...
<div class="app">
	<header class="app-header">
		...
		<div class="app-body-main-content">
                ...
                <a href="add-airline.php"><button class="button-add">Add Airline</button></a>
            ...
            <?php
            $stmt = "SELECT * FROM tour_guide.flights 
            LEFT JOIN tour_guide.airlines ON flights.Airline = airlines.airline
