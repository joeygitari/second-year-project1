...
<div class="app">
	<header class="app-header">
		...
		<div class="app-body-main-content">
                ...
                <a href="../signup.php"><button class="button-add">Add Place</button></a>
            ...
            <?php
            $stmt = "SELECT * FROM tour_guide.places 
            LEFT JOIN tour_guide.accommodation ON places.region=accommodation.Place; ";
